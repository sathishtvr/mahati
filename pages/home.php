    ...
    <div class="hero-slider">
        ...
        <div class="slide" style="background-image: url('<?php echo ASSETS_PATH; ?>images/carusel_br_3_1_1.jpg')">
            ...
            <div class="slide-content">
                ...
                <p data-aos="fade-up" data-aos-delay="200">Sophisticated designs that reflect your personal taste. We specialize in creating timeless elegance through carefully curated furniture, lighting, and color palettes that stand the test of time.</p>
                <div class="slide-features" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="slide" style="background-image: url('<?php echo ASSETS_PATH; ?>images/carusel_kitchen_1.jpg')">
            ...
            <div class="slide-content">
                ...
                <p data-aos="fade-up" data-aos-delay="200">Premium interior solutions for discerning clients. Experience unparalleled luxury with our bespoke design services that combine opulent materials with innovative concepts.</p>
                <div class="slide-features" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="slide" style="background-image: url('<?php echo ASSETS_PATH; ?>images/carusel_tv_1.jpg')">
            ...
            <div class="slide-content">
                ...
                <p data-aos="fade-up" data-aos-delay="200">Transform your vision into stunning reality. Our creative team brings imagination to life through innovative design solutions that exceed expectations and create lasting impressions.</p>
                <div class="slide-features" data-aos="fade-up" data-aos-delay="300">
                ...
                <a href="<?php echo page_url('contact'); ?>" class="cta-button" data-aos="fade-up" data-aos-delay="400">Start Project</a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="section-header" data-aos="fade-up">
            ...
            <p class="section-subtitle">
                Modular kitchens, wardrobes, TV units, bedrooms, living rooms, study/office spaces, false ceilings, lighting, wall finishes, flooring & more — all customized to your space and budget.
            </p>
        </div>
        <div class="expertise-grid">
            <div class="expertise-card" data-aos="fade-up" data-aos-delay="100">
                <div class="card-image">
                    <img src="<?php echo ASSETS_PATH; ?>images/portfolio-1.jpg" alt="Best Interior" />
            ...
            <div class="expertise-card" data-aos="fade-up" data-aos-delay="200">
                <div class="card-image">
                    <img src="<?php echo ASSETS_PATH; ?>images/portfolio-2.jpg" alt="Best Design" />
                    <div class="card-overlay">
                        <h3>Best Design</h3>
    ...
    <div class="container">
        ...
        <div class="services-grid">
            <div class="service-card" data-aos="fade-up" data-aos-delay="100">
                ...
                <p>Transform your home into a beautiful, functional space that reflects your personal style and meets your family's needs.</p>
            </div>
            ...
            <div class="service-card" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>Create inspiring work environments that boost productivity and leave lasting impressions on clients and employees.</p>
            </div>
        ...
        <div class="carousel-container">
            <div class="carousel-wrapper" id="carouselWrapper">
                ...
                <div class="carousel-slide">
                    <img src="<?php echo ASSETS_PATH; ?>images/modern-living-room-interior.jpg" alt="Modern Living Room Design">
                ...
                <!-- Slide 2 -->
                <div class="carousel-slide">
                    <img src="<?php echo ASSETS_PATH; ?>images/bedroom-cozy-decor.jpg" alt="Luxury Bedroom Suite">
                    <div class="carousel-overlay">
                        <div class="carousel-content">
                ...
                <!-- Slide 4 -->
                <div class="carousel-slide">
                    <img src="<?php echo ASSETS_PATH; ?>images/kitchen-contemporary-design.jpg" alt="Contemporary Kitchen Design">
                    <div class="carousel-overlay">
                        <div class="carousel-content">
                ...
                <!-- Slide 5 -->
                <div class="carousel-slide">
                    <img src="<?php echo ASSETS_PATH; ?>images/dining-room-classic-layout.jpg" alt="Dining Room Elegance Interior">
                    <div class="carousel-overlay">
                        <div class="carousel-content">
    ...
    <div class="container">
        ...
        <div class="services-grid">
            <div class="home-card-clean" data-aos="fade-up" data-aos-delay="100">
                ...
                <p>Successfully completed 300+ interior design projects across Karnataka, Tamil Nadu & Andhra Pradesh with satisfied clients</p>
            </div>
            ...
            <div class="home-card-clean" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>Premium boards & finishes with stringent quality control. Marine Plywood, HIGL, Laminated, HDHMR, Laminates, Lacquer glass</p>
            </div>
            ...
            <div class="home-card-clean" data-aos="fade-up" data-aos-delay="300">
                ...
                <p>Committed to delivering projects on schedule with professional project management and regular progress updates</p>
            </div>
            ...
            <div class="home-card-clean" data-aos="fade-up" data-aos-delay="400">
                ...
                <p>Contemporary & affordable design solutions for every budget without compromising on quality and style</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="title-content" data-aos="fade-up">
            ...
            <p class="main-description">
                We collaborate with leading brands and suppliers to bring you the finest materials and furnishings for your interior projects. Our partnerships ensure quality, reliability, and access to the latest design trends and innovations in the industry.
            </p>
        </div>
...
<section class="categories section">
    <div class="container">
        ...
        <p class="section-subtitle" data-aos="fade-up" data-aos-delay="100">Explore our diverse range of interior design categories to find the perfect style for your space</p>
        <div class="categories-grid">
            <div class="category-card" data-aos="fade-up" data-aos-delay="100">
                <img src="<?php echo ASSETS_PATH; ?>images/living-room-modern-interior.jpg" alt="Living Room">
                <div class="category-overlay">
                    <h3>LIVING ROOM</h3>
                </div>
            </div>
            <div class="category-card" data-aos="fade-up" data-aos-delay="200">
                <img src="<?php echo ASSETS_PATH; ?>images/kitchen-contemporary-design.jpg" alt="Kitchen">
                <div class="category-overlay">
                    <h3>KITCHEN</h3>
                </div>
            </div>
            <div class="category-card" data-aos="fade-up" data-aos-delay="300">
                <img src="<?php echo ASSETS_PATH; ?>images/bedroom-cozy-decor.jpg" alt="Bedroom">
                <div class="category-overlay">
                    <h3>BEDROOM</h3>
                </div>
            </div>
            <div class="category-card" data-aos="fade-up" data-aos-delay="400">
                <img src="<?php echo ASSETS_PATH; ?>images/bathroom-elegant-style.jpg" alt="Bathroom">
                <div class="category-overlay">
                    <h3>BATHROOM</h3>
                </div>
            </div>
            ...
            <div class="category-card" data-aos="fade-up" data-aos-delay="600">
                <img src="<?php echo ASSETS_PATH; ?>images/dining-room-classic-layout.jpg" alt="Dining">
                <div class="category-overlay">
                    <h3>DINING ROOM</h3>
                </div>
            </div>
    ...
    <div class="container">
        <div class="questions-content">
            <div class="questions-text" data-aos="fade-right">
                ...
                <p>We're here to help you with any questions about our interior design services. Get in touch with our expert team.</p>
        ...
        <div class="review-card" data-aos="fade-up" data-aos-delay="200">
            <div class="review-content">
                <div class="review-text">
                    <p>"The interior design team transformed our home beyond our expectations. Their attention to detail and creative vision made our space both beautiful and functional."</p>
                    <div class="reviewer">
                        <img src="<?php echo ASSETS_PATH; ?>images/gallary3.jpg" alt="Sarah Johnson">
                ...
                <div class="review-images">
                    <img src="<?php echo ASSETS_PATH; ?>images/gallary.jpg" alt="Before">
                    <img src="<?php echo ASSETS_PATH; ?>images/gallary1.jpg" alt="After">
                </div>
            </div>
        </div>
    </div>
...
<section class="newsletter section">
    <div class="container">
        ...
        <p data-aos="fade-up" data-aos-delay="100">Subscribe to our newsletter for the latest interior design trends, tips, and exclusive offers.</p>
        <form class="newsletter-form" method="POST" action="<?php echo SITE_URL; ?>/mahati/includes/form-handler.php" data-aos="fade-up" data-aos-delay="200">
...
<section class="section" style="background: linear-gradient(135deg, #ff6b35, #f7931e); color: white;">
    <div class="container">
        <div style="text-align: center;" data-aos="fade-up">
            ...
            <p style="font-size: 1.2rem; margin-bottom: 2rem; opacity: 0.9;">Book a free design consultation and let's create a home you'll love</p>
            <a href="<?php echo page_url('contact'); ?>" class="btn" style="background: white; color: #ff6b35; font-weight: 600;">Book Free Consultation</a>
        </div>
    </div>
</section>
